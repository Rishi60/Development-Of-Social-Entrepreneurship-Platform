        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <ul class="nav navbar-nav">
                    ...
                    <li id="first"><img src="arrow.png" width="25" height="25">&nbsp Solution Rejected</li>
...
<h2>Solution Rejected :</h2>
<?php
$result2 = mysqli_query($conn,"SELECT * from solution where status='REJECTED' AND uorsu_id='$u_id';");
