...
<head>
    ...
    ?>
    <title>Solutions submitted</title>
    <meta charset="utf-8">
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <ul class="nav navbar-nav">
                    ...
                    <li id="first"><img src="arrow.png" width="25" height="25">&nbsp Solution Submitted</li>
...
<center><h2>Solution Submitted</h2></center>
<?php
$result2 = mysqli_query($conn,"SELECT * from solution where uorsu_id='$u_id';");
...
if($count2>0)
{
    while ($row = mysqli_fetch_array($result2)) {
        ...
        $pname=$row2c["pname"];
        ?>
        <button class="accordion"><pre><b><font face="verdana" size="3"><img src="solution.jpg" width="50" height="37">  Solution ID  <?php echo $s_id."        For   ".$pname."                      Status:-  ".$status;?></font></b></pre></button>
        <div class="panel">
            <p> <?php echo $remark;?> </p>
