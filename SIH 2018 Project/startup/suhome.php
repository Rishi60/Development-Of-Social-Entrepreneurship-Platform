                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <center><li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href = "sulogout.php">Sign Out</a></li>
                                </ul>
                                <ul class="dropdown">
...
if($count>0)
{
    ...
    {
        ?><button class="accordion"><pre><b><font face="verdana" size="3"><?php echo $row["p_id"]."        ".$row["pname"];?></font></b></pre></button>
        <div class="panel">
            <p> <?php echo $row["pstatement"];?></p>
            <p> <?php echo $row["ministryname"];?> </p>
            <p> <?php echo $row["domain"];?> </p>
            <form  action="suaddsolution.php">
                <div align="center"><button type="submit">Participate</button></div>
            </form>
        </div>
        <?php
    }
